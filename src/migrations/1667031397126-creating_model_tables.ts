...
export class creatingModelTables1667031397126 implements MigrationInterface {
  name = 'creatingModelTables1667031397126';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`medication_entity\` ADD CONSTRAINT \`FK_d2230817d596ccfefb734bb93f5\` FOREIGN KEY (\`droneHostId\`) REFERENCES \`drone_entity\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }
